...
module PokemonsService {
    ...
    export function getName(name: string): PokemonI {
        const pokemones: Array<PokemonI> = db;
        // const pokemon : Array<PokemonI> = pokemones.filter(e=>e.name === name);
    ...
    export function getCreate(id:number,name:string,nombreTipo:string,fuerteTipo:string,debilTipo:string,img:string): PokemonI {
